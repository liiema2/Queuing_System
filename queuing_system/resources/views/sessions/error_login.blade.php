...
<link rel="stylesheet" href="{{ asset('../assets/css/session/error_login.css') }}">
...
<a  class="form-a-forgot-passwd" ><img src="{{url('../assets/images/icons/warning.png')}}" alt=""> Sai mật khẩu hoặc tên đăng nhập</a>
<button type="submit" class="submit_login">Đăng nhập</button>
<a  href="{{route('verify')}}" class="form-a-forgot-passwd1" >Quên mật khẩu?</a>
</form>
@endsection
