...
<div class="nvarContent">
    <div class="nvarContent-information">Thiết bị  <img src="{{ url('/assets/images/icons/Vector (1).png') }}" alt=""> <div> <a href="{{route('number_order')}}">Danh sách cấp số</a>  </div> <img src="{{ url('/assets/images/icons/Vector (1).png') }}" alt=""> <div>cấp số mới</div> </div>
