...
<div class="informtion_page_connter_first">Thông tin tài khoản</div>

<div>
    <div class="container">
        {{-- action="{{route('update_check',['id' => $device->id])}}" --}}

        <form action="{{route('manager_user_update')}}" class="form_update" method="POST" onsubmit="return checkPassword()" >
            @csrf
        <div class="row">
            <div class="col-md-5">

              <label for="input1">Họ tên <img src="{{ url('/assets/images/icons/Vector (2).png') }}" alt=""> </label>
              <input type="text" value="" id="input1" name="name" class="form-control">
            </div>
            <div class="col-md-5">
              <label for="input2">Tên đăng nhập <img src="{{ url('/assets/images/icons/Vector (2).png') }}" alt=""></label>
              <input type="text" value="" id="input1" name="nameuser" class="form-control">

            </div>
            <div class="col-md-5">
              <label for="input3">Số điện thoại <img src="{{ url('/assets/images/icons/Vector (2).png') }}" alt=""></label>
              <input type="text" id="input3" value="" name="phone_number" class="form-control">
            </div>
            <div class="col-md-5">
              <label for="input4">Mật khẩu <img src="{{ url('/assets/images/icons/Vector (2).png') }}" alt=""></label>
              <input type="password" id="input4" value="" name="password" class="form-control">
            </div>
            <div class="col-md-5">
              <label for="input5">Email<img src="{{ url('/assets/images/icons/Vector (2).png') }}" alt=""></label>
              <input type="text" id="input5" value="" name="email" class="form-control">
            </div>
            <div class="col-md-5">
              <label for="input5">Nhập lại mật khẩu<img src="{{ url('/assets/images/icons/Vector (2).png') }}" alt=""></label>
              <input type="password" id="input6" value="" name="password_confirmation" class="form-control">
            </div>
            <div class="col-md-5">
              <label for="input5">Vai trò<img src="{{ url('/assets/images/icons/Vector (2).png') }}" alt=""></label>
              <select id="input2"  value="" name="role" class="form-control form-select"style="padding:0px 0px 0px 12px;width:100%" >
            ...
            <div class="col-md-5">
              ...
              <select id="input2" value="" name="status" class="form-control form-select" style="padding:0px 0px 0px 12px;width:100%" >
